...
namespace IIS.Proba_10
{
    ...
    public class Город : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba_10.Улица fУлица;
        ...
        [PropertyStorage(new string[] {
                "Улица"})]
        [NotNull()]
        public virtual IIS.Proba_10.Улица Улица
        {
            get
            {
                ...
                IIS.Proba_10.Улица result = this.fУлица;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГородE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГородE", typeof(IIS.Proba_10.Город));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГородL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГородL", typeof(IIS.Proba_10.Город));
                }
            }
        }
    }
